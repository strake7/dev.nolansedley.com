...
If you had asked me in 2012 to describe from a developer's point-of-view how Microsoft would look in 2020 I would have never used the adjective appealing. Microsoft is embracing (developers, developers developers) and earning a new place for themselves in the community. Once a staunch opponent of open-source software they seem to have changed their tune and instead opted to embrace an open-source style. Say what you will about a "Embrace, extend, and extinguish" strategy, but I for one have enjoyed and benefited from this new standard. There are big changes that Microsoft has introduced to improve the developer experience like Windows Subsystem for Linux, PowerShell Core and .NET Core and then there are smaller QOL changes like Windows terminal. We are going to discuss the latter. 

The shell experience on Windows has always been lackluster in my experience. I think it is primarily because it has not been the most common way of doing developer chores. I have found that Windows usually embraces a GUI as opposed to command-line first approach to perform these operations. Really the only shell I was using on consistently on Windows was Git for Windows and that is a bash emulator. That said we have been doing quite a bit with Windows Docker containers lately and it has highlighted the need for me to refresh my PowerShell knowledge and environment. And because I am at times, frivolous, I set out to revisit my terminal choice on Windows to best host my shell experience.

## Desired features
After 7 years I was going to step outside of ConEmu and see what else was out there. The minimum features I desired in a terminal were:
...
Cmder is no longer the top terminal I would recommend though still a solid choice. It is a power user's dream though can be overwhelming with the breadth of functionality it encapsulates and the user experience is a dated.