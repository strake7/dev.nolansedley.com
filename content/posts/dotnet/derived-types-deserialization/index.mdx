...
date: 2020-06-07
image: ./dotnet-api-derived-types-code-example.png
imageAlt: Code capture of derived types registration
---
...
## Anything else?
- Documentation is important. The OpenApi specification has support for derived types and as of [this merge](https://github.com/domaindrivendev/Swashbuckle.AspNetCore/pull/1041) into [Swashbuckle.AspNetCore](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) you can get basic support for polymorphic schemas by using:
```c#
...
```
![alt](./dotnet-api-derived-types-doc-example.png)
