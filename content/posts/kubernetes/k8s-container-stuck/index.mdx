---
title: Kubernetes Pod(s) Stuck in ContainerPending 
date: 2023-09-28
---

When spinning up a large number of new pods such as with a release or scaling event you may encounter pods stuck in a `ContainerPending` state. 
